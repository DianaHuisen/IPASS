...
/// \brief
/// This is the AZmotorTest function.
/// \details
/// This is an Alphabet Braille motor testing sequence. This is simply to test if the motors behave correctly for each letter.
/// The "write( 0x00, 0b00000001);" changes a setting in MODE1 of the chip, which will allow you to write to every register.
/// Since this is to test ALL the letters in this file, and it does NOT require the assignLetterToMotor file, it IS added here. 
/// Then the allOff function will be called, followed by every letter of the alphabet. 
/// Unlike the AZledTest, this function is NOT looped.
    void AZmotorTest();
};
